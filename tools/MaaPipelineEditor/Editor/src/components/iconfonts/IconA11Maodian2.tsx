...
const IconA11Maodian2: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
  ...
  return (
    <svg viewBox="0 0 1024 1024" width={size + 'px'} height={size + 'px'} style={style} {...rest}>
      <path
        ...
        fill={getIconColor(color, 0, '#4378F0')}
        opacity=".1"
      />
      <path
        ...
        fill={getIconColor(color, 1, '#4378F0')}
        opacity=".5"
      />
      <path
        d="M512 357.248a154.752 154.752 0 1 1 0 309.504 154.752 154.752 0 0 1 0-309.504z"
        fill={getIconColor(color, 2, '#4378F0')}
      />
    </svg>
  );
};

IconA11Maodian2.defaultProps = {
  size: 18,
};

export default IconA11Maodian2;
