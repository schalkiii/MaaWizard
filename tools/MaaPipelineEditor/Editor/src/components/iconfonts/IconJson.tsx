...
const IconJson: FunctionComponent<Props> = ({ size, color, style: _style, ...rest }) => {
  ...
  return (
    <svg viewBox="0 0 1024 1024" width={size + 'px'} height={size + 'px'} style={style} {...rest}>
      ...
      <path
        ...
        fill={getIconColor(color, 3, '#F17F53')}
      />
      <path
        ...
        fill={getIconColor(color, 4, '#E9EDED')}
      />
    </svg>
  );
};

IconJson.defaultProps = {
  size: 18,
};
